...
public final class FrameworkConstants {
    ...
    public static final String CMS_DATA_FILE = PropertiesHelpers.getValue("CMS_DATA_FILE");
    public static final String ADMIN_EMAIL = PropertiesHelpers.getValue("ADMIN_EMAIL");
    public static final String ADMIN_PASSWORD = PropertiesHelpers.getValue("ADMIN_PASSWORD");
